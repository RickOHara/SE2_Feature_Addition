    ...
    (let* ((hdr-img (hdr/img bmp-bytes))
           ...
           (trans (case method
                       (1 ;(if (equal param nil)
                              ...
                              (reverse (bw img 250 nil param 0 0)));)
                       ...
                       (5 (reverse(two-tone img (first param) (second param)
                                     ...
                                     (fifth param) (sixth param) nil param 0 0)))
                       (6 (reverse (gray img nil param 0 0)))
                       (7 (reverse (tint-blu img nil param 0 0)))
                       (8 (reverse (tint-grn img nil param 0 0)))
                       (9 (reverse (tint-red img nil param 0 0)))
                       (10 (reverse (negatize img nil param 0 0)))
                       (11 (rot-180 img nil))
                       ...
                       (21 (if (or (< width (* 3 (car param))) (< height (* 3 (cadr param))))
                        ...
                        (25 (reverse (sepia img nil param 0 0)))
                        (26 (reverse (blur img nil param 0 0)))
                    (otherwise img)
                    ))
